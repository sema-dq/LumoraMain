...
export const ImpressumPage: React.FC<ImpressumPageProps> = ({ language, onBack }) => {
  ...
  return (
    <div className="pt-28 pb-24 px-6 sm:px-8 lg:px-10 bg-background">
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <Button
            variant="ghost"
            onClick={onBack}
            className="mb-10 p-0 h-auto font-normal text-primary hover:underline"
          >
          ...
          <div className="space-y-10">
            ...
            <Card className="border border-border shadow-sm hover:shadow-md transition-all">
              <CardHeader className="pb-4">
                <CardTitle className="text-2xl">{t.companyTitle}</CardTitle>
              </CardHeader>
              <CardContent className="text-base leading-relaxed space-y-2">
                ...
                <p>
                  Geschäftsführer: <span className="text-muted-foreground">William Yan</span>
                  <br />
                  Umsatzsteuer-Identifikationsnummer:{" "}
                  <span className="text-muted-foreground">DE123456789</span>
                </p>
                <p>
            ...
            <Card className="border border-border shadow-sm hover:shadow-md transition-all">
              <CardHeader className="pb-4">
                <CardTitle className="text-2xl">{t.responsibilityTitle}</CardTitle>
              </CardHeader>
            ...
            <Card className="border border-border shadow-sm hover:shadow-md transition-all">
              <CardHeader className="pb-4">
                <CardTitle className="text-2xl">{t.disclaimerTitle}</CardTitle>
              </CardHeader>
              <CardContent className="text-base leading-relaxed space-y-5 text-muted-foreground">
                {language === "de" ? (
                  <>
                    <p>
                  ...
                  <>
                    <p>
                      <strong>Liability for Content:</strong> As service providers, we are liable for our own content on these pages in accordance with general laws according to Section 7, Paragraph 1 of the TMG. However, pursuant to sections 8 to 10 of the TMG, we are not under obligation to monitor external information provided or stored on our website.
                    </p>
                    <p>
